...
lowerBound=np.array([23,41,133])
upperBound=np.array([40,150,255])
...
mloc=np.array([0,0])
DampingFactor=2  #ist use to smooth the mouse movement
#mouseLocation =mlocOld+(targetMouseLocation-mlocOld)/DampingFactor
while True:
    ret, img=cam.read()
